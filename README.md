...
* chromStart `the start genomic coordiate of specific event (e.g. peak, deletion, truncation or mutation) (0-base)`
* chromEnd `the end genomic coordiate of specific event`
* score `chromosome name`
* strand `the genomic sense (+) or antisense (-) strand of specific event`
